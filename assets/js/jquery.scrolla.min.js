    ...
    t = {
        ...
        animate: function(t, a) {
            ...
            s = i(window).height(), e = i(window).scrollTop(), n = e + s, i.each(t, function() {
                ...
                t = "animated", s = i(this).data("animate"), c = i(this).data("offset"), d = i(this).data("duration"), r = i(this).data("delay"), l = i(this).data("iteration"), h = i(this).outerHeight(), m = i(this).offset().top, o = m + h, c && (m += c, o -= c), 4 === a.animateCssVersion && (t = "animate__animated", s = "animate__" + s), i(this).css({
